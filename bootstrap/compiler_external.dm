...
const EXTERNAL_ID_ENV: int = 1105
const EXTERNAL_ID_FILE_IS_DIR: int = 1106
const EXTERNAL_ID_FILE_MKDIR: int = 1107
const EXTERNAL_ID_FILE_RENAME: int = 1108
const EXTERNAL_ID_FILE_SIZE: int = 1109
const EXTERNAL_ID_ENUM_CREATE_TUPLE_PTR: int = 1110
const EXTERNAL_ID_ENUM_GET_DATA: int = 1111
const EXTERNAL_ID_NET_CONNECT: int = 1112
const EXTERNAL_ID_NET_WRITE: int = 1113
...
def extern_names() -> list[str]:
    return [
        ...
        "__c_debug_on",
        "__c_eprint_text",
        "__c_debug_eprint_int",
        "__c_range_equal",
        "__c_fnv_hash_range",
        "__c_str_is_whitespace",
        "__c_union_create_int",
        "__c_union_create_float",
        "__c_union_create_str",
        "__c_union_create_bool",
        "__c_union_create_bytes",
        "__c_union_is_int",
        "__c_union_is_float",
        "__c_union_is_str",
        "__c_union_is_bool",
        ...
        "__c_str_to_bytes",
        "__c_bytes_to_str",
        "__c_dict_set_int_int",
        "__c_dict_set_int_str",
        "__c_dict_set_str_int",
        "__c_dict_set_str_str",
        "__c_dict_create_int_int",
        "__c_dict_create_int_str",
        "__c_dict_create_str_int",
        "__c_dict_create_str_str",
        "__c_dict_get_int_int",
        "__c_dict_get_int_str",
        "__c_dict_get_str_int",
        "__c_dict_get_str_str",
        "__c_dict_size_int_int",
        "__c_dict_size_int_str",
        "__c_dict_size_str_int",
        "__c_dict_size_str_str",
        "__c_utf8_rune_count",
        "__c_utf8_rune_at",
        "print",
        "eprint",
        ...
        "__c_enum_create_simple",
        "__c_enum_create_int",
        "__c_enum_create_float",
        "__c_enum_create_str",
        "__c_enum_create_bool",
        "__c_enum_get_tag",
        "__c_enum_get_int",
        "__c_enum_get_float",
        "__c_enum_get_str",
