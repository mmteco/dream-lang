...
const EXTERN_RETURN_CODES: str = "1111111162266666633624243323113235455533333545351255533255225555111155555555222222112135555552246355222226"
# EXTERN_DECL_CODES：每字符一个 LLVM 声明标志（'1'=通用 declare；'0'=专用 declare，由 LLVM 发射器硬编码），与 EXTERN_NAMES 行对齐。
const EXTERN_DECL_CODES: str = "1111111111111111111111111111111111111111111111111111111111111111000000000000111111001011111111111111111111"
